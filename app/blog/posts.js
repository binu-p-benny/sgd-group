...
export const blogPosts = [
  {
    ...
    tags: ['Structural Glazing', 'Curtain Wall', 'Facade Design'],
    readTime: '5 min read',
    ...
    faqs: [
      { q: 'What is structural glazing?', a: 'Structural glazing is a facade system where glass panels are bonded with structural silicone or point-fixed hardware, so the glass itself carries the load instead of a visible aluminium frame — giving a near-frameless exterior.' },
      { q: 'Is structural glazing energy-efficient?', a: 'Yes, when specified correctly. SGD Group\'s structural systems use continuous thermal breaks and insulated glazing units, so the reduced frame doesn\'t come at the cost of thermal performance.' },
      { q: 'Can structural glazing be retrofitted to an existing building?', a: 'It depends on the structure\'s facade grid and load capacity — our team assesses each building individually, as retrofits typically need more engineering than new construction.' },
    ],
  },
  {
    ...
    updatedDate: null,
    category: 'Design',
    tags: ['Skylights', 'Natural Light', 'Energy Efficiency'],
    readTime: '4 min read',
    author: 'SGD Group Team',
    image: '/skylight.png',
    content: [
    ...
    faqs: [
      { q: 'Do skylights cause leaks?', a: 'Not when installed correctly. Leaks are almost always a detailing or installation fault, not a fault of skylights themselves — our kerb and flashing details are engineered specifically for Kerala\'s monsoon conditions.' },
      { q: 'Will a skylight make a room too hot?', a: 'Insulated, low-E glazing controls solar heat gain significantly compared to older single-glazed skylights, so heat build-up is far less of a concern with a correctly specified unit.' },
      { q: 'Can a skylight be opened for ventilation?', a: 'Yes — we offer both fixed and vented skylight configurations, so a single unit can double as a source of daylight and natural airflow.' },
    ],
  },
  {
    ...
    updatedDate: null,
    category: 'Trends',
    tags: ['Frameless Doors', 'Sliding Systems', 'Interior Design'],
    readTime: '4 min read',
    author: 'SGD Group Team',
    ...
    faqs: [
      { q: 'Are frameless doors as secure as framed doors?', a: 'Yes — the reduced frame is purely visual. SGD Group\'s frameless systems use the same multi-point locking and toughened/laminated glass as our standard door ranges.' },
      { q: 'Do frameless sliding doors need more maintenance?', a: 'They need the same routine care as any premium sliding system — clean tracks and occasional hardware checks. The slimmer profile doesn\'t add extra upkeep.' },
      { q: 'What glass is used in frameless sliding doors?', a: 'We use toughened or laminated safety glass as standard, sized to the specific span and wind-load requirements of each project.' },
    ],
  },
];
